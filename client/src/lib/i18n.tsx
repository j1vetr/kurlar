...
const translations: Translations = {
  ...
  'hero.play_video': { TR: 'Videoyu Oynat', EN: 'Play Video', AR: 'تشغيل الفيديو', ES: 'Reproducir Video', PT: 'Reproduzir Vídeo' },
  ...
  'product.series_desc': { 
    TR: 'inç Yüksek Sıcaklık dalgıç motorları için kapsamlı performans verileri.', 
    EN: 'inch High Temperature submersible motors comprehensive performance data.', 
    AR: 'بوصة بيانات الأداء الشاملة لمحركات الغاطسة ذات درجة الحرارة العالية.', 
    ES: 'pulgadas datos completos de rendimiento para motores sumergibles de alta temperatura.', 
    PT: 'polegadas dados abrangentes de desempenho para motores submersíveis de alta temperatura.' 
  },
  'product.series_title': { TR: 'SERİSİ', EN: 'SERIES', AR: 'سلسلة', ES: 'SERIE', PT: 'SÉRIE' },
  ...
  'seo.home.title': { TR: 'Dalgıç Pompa & Dalgıç Motor Üreticisi', EN: 'Submersible Pump & Submersible Motor Manufacturer', AR: 'الرئيسية', ES: 'Inicio', PT: 'Início' },
  'seo.home.desc': { TR: 'Kurlar, 1975’ten beri Türkiye’de dalgıç pompa ve dalgıç motor üretiyor. Paslanmaz çelik, noryl ve pik döküm dalgıç pompalar; dalgıç motorlar. 40’tan fazla ülkeye ihracat.', EN: 'Kurlar has manufactured submersible pumps and submersible motors in Turkey since 1975. Stainless steel, Noryl and cast iron pumps — exported to more than 40 countries.', AR: 'مضخات كورلار - حلول مضخات ومحركات غاطسة عالية الكفاءة.', ES: 'Bombas Kurlar - Soluciones de bombas y motores sumergibles de alta eficiencia.', PT: 'Bombas Kurlar - Soluções de bombas e motores submersíveis de alta eficiência.' },
  
  'seo.about.title': { TR: 'Hakkımızda – 1975’ten Beri Dalgıç Pompa ve Motor Üreticisi', EN: 'About Us – Submersible Pump and Motor Manufacturer Since 1975', AR: 'من نحن', ES: 'Sobre Nosotros', PT: 'Sobre Nós' },
  'seo.about.desc': { TR: 'Kurlar Dalgıç Pompa & Motor 1975’te İstanbul’da kuruldu. Bugün Tire/İzmir’de 35.000 m² tesiste 200’e yakın çalışanıyla dalgıç pompa ve dalgıç motor üretiyor, 40’tan fazla ülkeye ihracat yapıyor.', EN: 'Kurlar was founded in Istanbul in 1975. Today it manufactures submersible pumps and motors in Tire/İzmir with a team of nearly 200, exporting to more than 40 countries.', AR: 'معلومات مفصلة عن مضخات كورلار، تاريخنا ورؤيتنا.', ES: 'Información detallada sobre Bombas Kurlar, nuestra historia y visión.', PT: 'Informações detalhadas sobre Bombas Kurlar, nossa história e visão.' },
  ...
  'seo.certificates.desc': { TR: 'Kurlar’ın kalite belgeleri: TSE uygunluk belgesi, KP serisi dalgıç pompalar ve KM serisi dalgıç motorlar için CE uygunluk beyanları, ISO 9001, ISO 14001 ve ISO 45001 sertifikaları.', EN: 'Kurlar quality certificates: TSE conformity certificate, CE declarations for KP series submersible pumps and KM series submersible motors, ISO 9001, ISO 14001 and ISO 45001.', AR: 'وثائق الجودة والمعايير الخاصة بنا.', ES: 'Nuestros documentos de calidad y estándares.', PT: 'Nossos documentos de qualidade e padrões.' },
  ...
  // Certificates - List
  'certs.tse.title': { TR: 'Türk Standartlarına Uygunluk Belgesi', EN: 'Certificate of Conformity to Turkish Standards', AR: 'شهادة المطابقة للمواصفات التركية', ES: 'Certificado de Conformidad con las Normas Turcas', PT: 'Certificado de Conformidade com as Normas Turcas' },
  'certs.tse.desc': { TR: 'Ürünlerimizin Türk Standartları Enstitüsü tarafından belirlenen standartlara uygunluğunu belgeleyen sertifika.', EN: 'Certificate documenting the conformity of our products to the standards determined by the Turkish Standards Institute.', AR: 'شهادة توثق مطابقة منتجاتنا للمعايير التي حددها معهد المعايير التركي.', ES: 'Certificado que documenta la conformidad de nuestros productos con las normas determinadas por el Instituto de Normas Turcas.', PT: 'Certificado que documenta a conformidade de nossos produtos com as normas determinadas pelo Instituto de Normas Turco.' },
  'certs.cekp.title': { TR: 'CE Uygunluk Beyanı (Pompalar)', EN: 'CE Declaration of Conformity (Pumps)', AR: 'إعلان المطابقة CE (المضخات)', ES: 'Declaración de Conformidad CE (Bombas)', PT: 'Declaração de Conformidade CE (Bombas)' },
  'certs.cekp.desc': { TR: 'KP Serisi Dalgıç Pompaların Avrupa Birliği güvenlik, sağlık ve çevre koruma standartlarına uygunluğunu gösterir.', EN: 'Indicates the compliance of KP Series Submersible Pumps with European Union safety, health and environmental protection standards.', AR: 'يشير إلى امتثال مضخات KP Series الغاطسة لمعايير السلامة والصحة وحماية البيئة في الاتحاد الأوروبي.', ES: 'Indica el cumplimiento de las bombas sumergibles de la serie KP con las normas de seguridad, salud y protección ambiental de la Unión Europea.', PT: 'Indica a conformidade das bombas submersíveis da série KP com as normas de segurança, saúde e proteção ambiental da União Europeia.' },
  'certs.cekm.title': { TR: 'CE Uygunluk Beyanı (Motorlar)', EN: 'CE Declaration of Conformity (Motors)', AR: 'إعلان المطابقة CE (المحركات)', ES: 'Declaración de Conformidad CE (Motores)', PT: 'Declaração de Conformidade CE (Motores)' },
  'certs.cekm.desc': { TR: 'KM Serisi Dalgıç Motorların Avrupa Birliği direktiflerine (LVD, EMC) tam uyumlu olduğunu belgeleyen deklarasyon.', EN: 'Declaration documenting that KM Series Submersible Motors are fully compliant with European Union directives (LVD, EMC).', AR: 'إعلان يوثق أن المحركات الغاطسة من سلسلة KM متوافقة تمامًا مع توجيهات الاتحاد الأوروبي (LVD ، EMC).', ES: 'Declaración que documenta que los motores sumergibles de la serie KM cumplen totalmente con las directivas de la Unión Europea (LVD, EMC).', PT: 'Declaração que documenta que os motores submersíveis da série KM estão em total conformidade com as diretivas da União Europeia (LVD, EMC).' },
