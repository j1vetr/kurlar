      ...
      subSpecs: [
        {
          ...
          data: [
            ...
            ['KM6-30', '30', '22', '380', '2860', '48.5', '188', '82 / 83 / 83', '0.63 / 0.71 / 0.84', '72.2', '90.7', '20'],
            ['', '', '', '400', '2875', '46.7', '180', '81 / 82 / 82', '0.59 / 0.67 / 0.82', '72.0', '101.5', '20'],
            ['', '', '', '415', '2885', '45', '174', '82 / 83 / 83', '0.58 / 0.66 / 0.81', '71.7', '110.0', '20'],
            ...
            ['', '', '', '415', '2895', '52.9', '204', '83 / 84 / 84', '0.59 / 0.67 / 0.82', '86.6', '148.4', '20'],
            ['KM6-40', '40', '30', '380', '2880', '64.6', '250', '84 / 85 / 85', '0.65 / 0.73 / 0.85', '99.3', '135.7', '26.5'],
            ['', '', '', '400', '2895', '62.1', '240', '82 / 83 / 83', '0.61 / 0.69 / 0.83', '99.0', '152.0', '26.5'],
            ['', '', '', '415', '2905', '59.9', '231', '83 / 84 / 84', '0.59 / 0.67 / 0.82', '98.8', '164.0', '26.5'],
            ['KM6-50', '50', '37', '380', '2890', '79.7', '316', '84 / 85 / 85', '0.65 / 0.73 / 0.85', '122.6', '193.6', '26.5'],
            ['', '', '', '400', '2905', '76.7', '303', '80 / 81 / 83', '0.61 / 0.69 / 0.83', '122.3', '217.1', '26.5'],
            ['', '', '', '415', '2915', '74.7', '289', '81 / 82 / 84', '0.59 / 0.67 / 0.82', '122.0', '235.4', '26.5'],
            ['KM6-60', '60', '45', '380', '2890', '97', '375', '83 / 84 / 84', '0.61 / 0.69 / 0.83', '148.4', '234.4', '26.5'],
            ['', '', '', '400', '2905', '93.4', '361', '86 / 85 / 87', '0.59 / 0.67 / 0.82', '148.1', '262.9', '26.5'],
            ['', '', '', '415', '2915', '90', '357', '85 / 86 / 88', '0.59 / 0.67 / 0.82', '147.8', '285.2', '26.5']
          ]
        },
        {
        ...
        },
        {
          ...
          data: [
            ...
            ['', '', '', '415', '2895', '54.9', '212', '87 / 87 / 85', '0.84 / 0.88 / 0.88', '85', '131', '45'],
            ['KM8-40', '40', '30', '380', '2920', '61.7', '239', '83 / 84 / 84', '0.75 / 0.8 / 0.89', '98', '125', '45'],
            ['', '', '', '400', '2930', '59.3', '229', '83 / 84 / 84', '0.69 / 0.76 / 0.87', '98', '140', '45'],
            ['', '', '', '415', '2935', '57.8', '223', '83 / 84 / 84', '0.67 / 0.75 / 0.86', '97', '149', '45'],
            ['KM8-50', '50', '37', '380', '2925', '74.3', '287', '84 / 85 / 85', '0.75 / 0.8 / 0.89', '121', '155', '45'],
            ['', '', '', '400', '2930', '71.4', '276', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '121', '175', '45'],
            ['', '', '', '415', '2935', '69.6', '269', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '120', '188', '45'],
            ['KM8-60', '60', '45', '380', '2930', '90.4', '349', '84 / 85 / 85', '0.75 / 0.8 / 0.89', '147', '215', '45'],
            ['', '', '', '400', '2935', '86.8', '336', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '147', '239', '45'],
            ['', '', '', '415', '2940', '84.6', '327', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '146', '259', '45'],
            ['KM8-70', '70', '52', '380', '2935', '103.3', '399', '84 / 85 / 85', '0.77 / 0.83 / 0.9', '170', '276', '45'],
            ['', '', '', '400', '2940', '99.2', '383', '85 / 86 / 86', '0.72 / 0.78 / 0.88', '169', '307', '45'],
            ['', '', '', '415', '2945', '96.7', '374', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '169', '335', '45'],
            ['KM8-75', '75', '55', '380', '2930', '110.5', '427', '84 / 85 / 86', '0.77 / 0.83 / 0.9', '180', '298', '45'],
            ['', '', '', '400', '2945', '107.4', '415', '84 / 85 / 86', '0.72 / 0.78 / 0.88', '180', '338', '45'],
            ['', '', '', '415', '2950', '103.5', '400', '84 / 85 / 86', '0.69 / 0.76 / 0.87', '179', '362', '45'],
            ['KM8-80', '80', '60', '380', '2935', '119.1', '460', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '196', '298', '45'],
            ['', '', '', '400', '2945', '115.7', '447', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '196', '317', '45'],
            ['', '', '', '415', '2950', '112.9', '436', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '195', '353', '45'],
            ['KM8-90', '90', '67', '380', '2935', '134.6', '520', '84 / 85 / 85', '0.75 / 0.8 / 0.89', '220', '352', '45'],
            ['', '', '', '400', '2945', '129.3', '499', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '219', '393', '45'],
            ['', '', '', '415', '2950', '126', '487', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '219', '427', '45'],
            ['KM8-100', '100', '75', '380', '2935', '150.7', '582', '83 / 84 / 84', '0.77 / 0.83 / 0.9', '246', '417', '55'],
            ['', '', '', '400', '2945', '144.7', '559', '84 / 85 / 85', '0.72 / 0.78 / 0.88', '246', '472', '55'],
            ['', '', '', '415', '2950', '141.1', '545', '84 / 85 / 85', '0.69 / 0.76 / 0.87', '245', '510', '55'],
            ['KM8-110', '110', '81', '380', '2920', '162.7', '629', '84 / 85 / 85', '0.75 / 0.8 / 0.89', '266', '467', '55'],
            ['', '', '', '400', '2925', '156.3', '604', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '265', '528', '55'],
            ['', '', '', '415', '2935', '152.4', '589', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '265', '569', '55'],
            ['KM8-125', '125', '92', '380', '2920', '184.8', '714', '84 / 85 / 85', '0.75 / 0.8 / 0.89', '305', '555', '55'],
            ['', '', '', '400', '2925', '177.5', '686', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '305', '626', '55'],
            ['', '', '', '415', '2935', '173.1', '669', '85 / 86 / 86', '0.67 / 0.75 / 0.86', '304', '674', '55'],
            ['KM8-135', '135', '100', '380', '2920', '200.9', '777', '87 / 88 / 88', '0.75 / 0.8 / 0.89', '330', '601', '55'],
            ['', '', '', '400', '2925', '195.2', '755', '88 / 89 / 89', '0.69 / 0.76 / 0.87', '330', '677', '55'],
            ['', '', '', '415', '2935', '190.5', '737', '88 / 89 / 89', '0.67 / 0.75 / 0.86', '329', '729', '55'],
            ['KM8-150', '150', '110', '380', '2870', '225.6', '871', '88 / 88 / 88', '0.77 / 0.85 / 0.86', '368', '670', '55'],
            ['', '', '', '400', '2875', '207.7', '802', '89 / 89 / 88', '0.75 / 0.83 / 0.86', '368', '755', '55'],
            ['', '', '', '415', '2895', '203', '784', '89 / 89 / 88', '0.75 / 0.82 / 0.86', '367', '813', '55']
          ]
        },
        {
        ...
        },
        {
          ...
          data: [
            ...
            ['', '', '', '415', '2895', '132', '510', '86 / 86 / 86', '0.72 / 0.78 / 0.88', '242', '297', '75'],
            ['KM10-110', '110', '81', '380', '2880', '159', '614', '84 / 85 / 85', '0.79 / 0.84 / 0.91', '264', '265', '75'],
            ['', '', '', '400', '2895', '153', '591', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '263', '297', '75'],
            ['', '', '', '415', '2905', '147', '567', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '262', '321', '75'],
            ['KM10-125', '125', '92', '380', '2890', '179', '691', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '299', '300', '75'],
            ['', '', '', '400', '2905', '174', '672', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '298', '336', '75'],
            ['', '', '', '415', '2915', '169', '652', '85 / 86 / 86', '0.72 / 0.78 / 0.88', '297', '364', '75'],
            ['KM10-135', '135', '100', '380', '2890', '188', '726', '85 / 86 / 86', '0.78 / 0.73 / 0.9', '323', '374', '75'],
            ['', '', '', '400', '2905', '176', '679', '85 / 86 / 86', '0.74 / 0.78 / 0.88', '322', '418', '75'],
            ['', '', '', '415', '2915', '168', '648', '85 / 86 / 86', '0.71 / 0.77 / 0.88', '321', '452', '75'],
            ['KM10-150', '150', '110', '380', '2890', '216', '834', '85 / 86 / 86', '0.77 / 0.83 / 0.9', '359', '416', '75'],
            ['', '', '', '400', '2905', '210', '811', '85 / 86 / 86', '0.72 / 0.78 / 0.88', '358', '464', '75'],
            ['', '', '', '415', '2915', '205', '791', '85 / 86 / 86', '0.69 / 0.76 / 0.87', '357', '503', '75'],
            ['KM10-175', '175', '129', '380', '2910', '248', '957', '86 / 87 / 87', '0.79 / 0.84 / 0.91', '421', '479', '75'],
            ['', '', '', '400', '2925', '238', '919', '87 / 88 / 88', '0.75 / 0.8 / 0.89', '420', '540', '75'],
            ['', '', '', '415', '2935', '232', '896', '87 / 88 / 88', '0.72 / 0.78 / 0.88', '419', '584', '75'],
            ['KM10-200', '200', '147', '380', '2900', '282', '1089', '86 / 87 / 87', '0.79 / 0.84 / 0.91', '479', '553', '75'],
            ['', '', '', '400', '2915', '274', '1058', '86 / 87 / 87', '0.75 / 0.8 / 0.89', '479', '619', '75'],
            ['', '', '', '415', '2925', '264', '1019', '87 / 88 / 88', '0.72 / 0.78 / 0.88', '478', '674', '75'],
            ['KM10-225', '225', '166', '380', '2890', '322', '1243', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '541', '625', '75'],
            ['', '', '', '400', '2905', '309', '1193', '86 / 87 / 87', '0.75 / 0.8 / 0.89', '540', '698', '75'],
            ['', '', '', '415', '2915', '302', '1166', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '538', '758', '75'],
            ['KM10-250', '250', '185', '380', '2895', '359', '1386', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '602', '903', '75'],
            ['', '', '', '400', '2905', '349', '1347', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '601', '1015', '75'],
            ['', '', '', '415', '2915', '336', '1297', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '599', '1098', '75'],
            ['KM10-275', '275', '205', '380', '2890', '396', '1529', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '669', '1003', '75'],
            ['', '', '', '400', '2905', '389', '1502', '86 / 87 / 87', '0.75 / 0.8 / 0.89', '668', '1128', '75'],
            ['', '', '', '415', '2915', '370', '1428', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '667', '1223', '75'],
            ['KM10-300', '300', '225', '380', '2895', '417', '1610', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '703', '1054', '75'],
            ['', '', '', '400', '2905', '390', '1505', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '702', '1186', '75'],
            ['', '', '', '415', '2915', '372', '1436', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '700', '1283', '75'],
            ['KM10-325', '325', '242', '380', '2890', '452', '1745', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '777', '1165', '75'],
            ['', '', '', '400', '2905', '423', '1633', '86 / 87 / 87', '0.75 / 0.8 / 0.89', '775', '1309', '75'],
            ['', '', '', '415', '2915', '403', '1556', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '772', '1415', '75'],
            ['KM10-350', '350', '260', '380', '2895', '487', '1880', '85 / 86 / 86', '0.79 / 0.84 / 0.91', '851', '1276', '75'],
            ['', '', '', '400', '2905', '455', '1756', '85 / 86 / 86', '0.75 / 0.8 / 0.89', '849', '1434', '75'],
            ['', '', '', '415', '2915', '434', '1675', '86 / 87 / 87', '0.72 / 0.78 / 0.88', '846', '1551', '75']
          ]
        },
        {
          title: '10" Sandık Ölçüleri ve Ağırlıklar',
          columns: ['Tip', 'W (cm)', 'L (cm)', 'H (cm)', 'Ağırlık (Dahil kg)'],
          data: [
            ['KM10-125', '25', '175', '40', '290'],
            ['KM10-150', '25', '190', '40', '330'],
            ['KM10-175', '25', '205', '40', '380'],
            ['KM10-200', '25', '225', '40', '430']
          ]
        }
      ],
      options: [
      ...
      seriesDetails: {
        '6': {
          technicalSpecs: [
            ...
            'M12 Saplamalar ile 6" NEMA Standartlarına Uygun Üst Flanş',
            'Koruma Sınıfı : IP86',
          ...
          options: [
             ...
             '100m’ye kadar istenilen ölçüde kablo ile üretilebilir',
             'Direkt ve Yıldız/Üçgen Yol Verme',
             '4 damarlı kablo ile üretilebilir (3 faz & 1 topraklama)',
             'Motorlar 500V, 525V, 630V ve 1000V’a uygun olarak üretilebilir (detaylar için KURLAR ile iletişime geçiniz)',
             'Motorlar 75°C ve 90°C olarak üretilebilir',
             '4kW-22kW (5.5HP-30HP) motorlar 26.5kN eksenel yük taşıma kapasitesi ile üretilebilir'
          ],
          advantages: [
            ...
            'NBR Kum Çanı',
            'Basınç değişikliklerini kontrol etmek için paslanmaz çelik ya da bronz basınç dengeleyici çek-valf',
            'Genleşme basıncını minimize etmek için NBR diyafram',
        ...
        '8': {
          ...
          options: [
            ...
            'Motorlar 500V, 525V, 630V ve 1000V’a uygun olarak üretilebilir (Teknik özellikler için KURLAR ile iletişime geçiniz)',
            'Motorlar 75°C ve 90°C olarak üretilebilir',
            '22kW–67kW (30HP–90HP) Motorlar 55kN Eksenel Yük Taşıma Kapasitesi ile üretilebilir',
            'Mekanik Keçe SIC/SIC-NBR-304 olarak üretilebilir'
          ],
          advantages: [
            'Düşük İşletme Maliyeti için Yüksek Verimli Dizayn',
