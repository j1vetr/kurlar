  ...
  km: {
    TR: {
      ...
      subSpecs: [
        ...
        {
          title: 'Sandık Ölçüleri ve Ağırlıklar',
          columns: ['Tip', 'W (cm)', 'L (cm)', 'H (cm)', 'Ağırlık (Dahil kg)'],
          data: [
            ['KM6-5.5', '17.4', '92.4', '27.4', '46'],
            ['KM6-7.5', '17.4', '92.4', '27.4', '50'],
            ['KM6-10', '17.4', '115.4', '27.4', '55'],
            ['KM6-12.5', '17.4', '115.4', '27.4', '60'],
            ['KM6-15', '17.4', '115.4', '27.4', '65'],
            ['KM6-17.5', '17.4', '115.4', '27.4', '70'],
            ['KM6-20', '17.4', '115.4', '27.4', '76'],
            ['KM6-25', '17.4', '139.4', '27.4', '88'],
            ['KM6-30', '17.4', '139.4', '27.4', '100'],
            ['KM6-35', '17.4', '159.4', '27.4', '112']
          ]
        }
      ],
      options: [
    ...
    EN: {
      ...
      subSpecs: [
        ...
        {
          title: 'Shipping Dimensions & Weights',
          columns: ['Type', 'W (cm)', 'L (cm)', 'H (cm)', 'Weight (Incl. kg)'],
          data: [
            ['KM6-5.5', '17.4', '92.4', '27.4', '46'],
            ['KM6-7.5', '17.4', '92.4', '27.4', '50'],
            ['KM6-10', '17.4', '115.4', '27.4', '55'],
